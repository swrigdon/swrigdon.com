...
import BrawliseumPicture            from "../../img/brawliseum.jpg";
import RealityFlowPicture           from "../../img/realityFlow.jpg";
    ...
    return(
        <Grid templateColumns = "repeat(5, 1fr)">
            ...
            <GridItem 
                ...
                marginTop = {5}
            >
                    <h3 style={{fontSize: "2.25em"}}>School Projects</h3>
                    <hr />
            </GridItem>
            <GridItem 
                colSpan = {1}
            ...
            >
                <Center>
                    <img src = {BrawliseumPicture} alt = "brawliseum"/>
                </Center>
            </GridItem>
            <GridItem 
                colSpan = {4}
            ...
            >
                <Center>
                    <img src = {RealityFlowPicture} alt = "brawliseum"/>
                </Center>
            </GridItem>
            <GridItem 
                colSpan = {4}
