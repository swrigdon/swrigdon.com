...
{@render ContentCard(
    [{
        href: "https://www.nocapshows.com",
        title: "NoCap Shows Website",
        src: "https://cloud.swrigdon.com/s/fwDLbMDbWwfPtin/preview",
        alt: "NoCap Logo"
    }],
    {
        heading: "Software Engineer - NoCap, LLC [Aug 2021 - Sep 2022]",
